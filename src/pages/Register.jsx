...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-12">
      ...
      >
        <h1 className="text-3xl font-bold gradient-text text-center">Create account</h1>
        <p className="text-gray-400 text-center mt-2">Start your AI-powered job search</p>
